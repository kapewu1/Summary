...
//) {
//    Scaffold(topBar = {
//        SummaryAppBar(title = "A.Reader", navController = navController )
//
//
////    },
//        floatingActionButton = {
//            FABContent{
//                navController.navigate(SummaryScreens.SearchScreen.name)
//            }
//
//        }) {
        //content
...
//                    modifier = Modifier
//                        .clickable {
//                            navController.navigate(SummaryScreens.StatsScreen.name)
//                        }
//                        .size(45.dp),
...
//        navController.navigate(SummaryScreens.UpdateScreen.name +"/$it")
//
//    }
//
//
